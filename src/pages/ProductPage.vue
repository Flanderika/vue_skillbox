        ...
        <div class="item__form">
          <form class="form" action="#" method="POST">
            ...
            <fieldset class="form__block">
              ...
              <ul class="colors">
                <li class="colors__item" v-for="productColor in product.color" :key="productColor">
                  <label class="colors__label">
                    <input class="colors__radio sr-only" type="radio" name="color-item" :value="productColor" v-model="color">
                    <span class="colors__value" :style="{backgroundColor: productColor}">
                    </span>
                  </label>
                </li>
              </ul>
